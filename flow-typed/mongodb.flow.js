...
declare module 'mongodb' {
  ...
  declare export class MongoClient mixins EventEmitter {
  ...
  declare export type ClientSession = {
     ...
     * @param  Optional callback for completion of this operation
     */
    ...
    /**
     * Ends this session on the server
     * @param  Optional settings. Currently reserved for future use
     * @param  Optional callback for completion of this operation
     */
     ...
     * @param  A class representing a client session on the server
  ...
  */
  declare export interface ReadConcern {
  ...
  */
   ...
   */
  declare export interface TransactionOptions {
    readConcern?: ReadConcern;
    writeConcern?: WriteConcern;
    readPreference?: any;
  }
  declare export interface MongoClientCommonOption {
    /**
  ...
  */
  ...
  declare export type Condition<T, P> = {
    $eq?: "NO PRINT IMPLEMENTED: IndexedAccessType",
    $gt?: "NO PRINT IMPLEMENTED: IndexedAccessType",
    $gte?: "NO PRINT IMPLEMENTED: IndexedAccessType",
    $in?: "NO PRINT IMPLEMENTED: IndexedAccessType"[],
    $lt?: "NO PRINT IMPLEMENTED: IndexedAccessType",
    $lte?: "NO PRINT IMPLEMENTED: IndexedAccessType",
    $ne?: "NO PRINT IMPLEMENTED: IndexedAccessType",
    $nin?: "NO PRINT IMPLEMENTED: IndexedAccessType"[],
    $and?: (
      | FilterQuery<"NO PRINT IMPLEMENTED: IndexedAccessType">
      | "NO PRINT IMPLEMENTED: IndexedAccessType"
    )[],
    $or?: (
      | FilterQuery<"NO PRINT IMPLEMENTED: IndexedAccessType">
      | "NO PRINT IMPLEMENTED: IndexedAccessType"
   ...
   */
  declare export type UpdateQuery<T> = {
    $inc?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: number
        },
    $min?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: number
        },
    $max?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: number
        },
    $mul?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: number
        },
    $set?: | Partial<T>
    ...
    $unset?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: ""
        },
    $rename?: | {
          [key: string]: "NO PRINT IMPLEMENTED: TypeOperator"
        }
      | {
          [key: string]: string
        },
    $currentDate?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: {
            $type: "date" | "timestamp"
          }
    ...
    $pop?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: 1
        },
    $pull?: | Partial<T>
      | {
          [key: string]: Condition<T, "NO PRINT IMPLEMENTED: TypeOperator">
        },
    $push?: | Partial<T>
      | {
          [key: string]: any
    ...
    $bit?: | "NO PRINT IMPLEMENTED: MappedType"
      | {
          [key: string]: any
        }
  };
  declare export type FilterQuery<T> =
  ...
  declare export interface CollectionAggregationOptions {
     ...
     */
    bypassDocumentValidation?: boolean;
    hint?: string | "NO PRINT IMPLEMENTED: ObjectKeyword";
    raw?: boolean;
    promoteLongs?: boolean;
   ...
   */
  declare export class Cursor<T> mixins Readable {
    sortValue: string;
    timeout: boolean;
   ...
   */
  declare export class AggregationCursor<T> mixins Readable {
    /**
   ...
   */
  declare export type CommandCursorResult = any | void;
  /**
   * http://mongodb.github.io/node-mongodb-native/3.1/api/CommandCursor.html
   */
  declare export class CommandCursor mixins Readable {
    /**
   ...
   */
  declare export class GridFSBucketReadStream mixins Readable {
    id: ObjectID;
    constructor(
   ...
   */
  declare export class GridFSBucketWriteStream mixins Writable {
    id: GridFSBucketWriteStreamId;
    constructor(
      bucket: GridFSBucket,
      filename: string,
   ...
   */
  declare export class ChangeStream mixins Readable {
    constructor(
  ...
  declare export interface ChangeStreamOptions {
    fullDocument?: string;
  ...
  declare export interface LoggerState {
    type: string;
    message: string;
    className: string;
    pid: number;
   ...
   */
  declare export interface CollationDocument {
    locale: string;
    strength?: number;
    caseLevel?: boolean;
    caseFirst?: string;
   ...
   */
  declare export interface IndexSpecification {
    key: "NO PRINT IMPLEMENTED: ObjectKeyword";
    name?: string;
    background?: boolean;
    unique?: boolean;
    partialFilterExpression?: "NO PRINT IMPLEMENTED: ObjectKeyword";
    sparse?: boolean;
    expireAfterSeconds?: number;
    storageEngine?: "NO PRINT IMPLEMENTED: ObjectKeyword";
    weights?: "NO PRINT IMPLEMENTED: ObjectKeyword";
    default_language?: string;
